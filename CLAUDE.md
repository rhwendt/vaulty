...
All subagents default to Sonnet. Users control model selection via Claude Code app settings or environment variables (see README.md for configuration guide). Vaulty doesn't hardcode model requirements - it works with any Claude model available to the user.
